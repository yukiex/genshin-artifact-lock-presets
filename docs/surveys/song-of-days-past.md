...
## 1. 推奨設定の根拠
- [ ] `docs/references/song-of-days-past/` に部位ごとのスクリーンショットを配置（flower / plume / sands / goblet / circlet）。
...
| 杯 | `goblet.png` | 炎元素ダメージ / 雷元素ダメージ / 風元素ダメージ / 攻撃力% | 攻撃力% / 会心率 / 会心ダメージ | 会心率, 会心ダメージ |
| 冠 | `circlet.png` | 会心率 / 会心ダメージ | 攻撃力% / 会心率 / 会心ダメージ | 会心率, 会心ダメージ |

- YAML 反映時は `presets/song-of-days-past/recommended.yml`を更新する。
